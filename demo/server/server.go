...
func main(){
	...
	chassis.RegisterSchema("rest", &p.RestfulInvoke{}, server.WithSchemaID("ServerRestful"))
	chassis.RegisterSchema("rest", &p.RestfulSpecial{}, server.WithSchemaID("ServerRestfulSpecial"))
